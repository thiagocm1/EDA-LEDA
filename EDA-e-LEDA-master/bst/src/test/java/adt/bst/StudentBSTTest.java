...
public class StudentBSTTest {
	...
	public void testOrder(){
		fillTree();  // -40 -34 0 2 5 6 9 12 23 67 76 232
		int k = 3;
		assertEquals(new Integer(0), tree.orderStatistic(k));
		 k = 1;
		assertEquals(new Integer(-40), tree.orderStatistic(k));
	...
	public void testIsDecedent(){
		...
		assertTrue(tree.isDecedent(6, 9));
		assertFalse(tree.isDecedent(2, -40));
		assertFalse(tree.isDecedent(-40, -34));
		assertFalse(tree.isDecedent(5, 6));
		assertTrue(tree.isDecedent(9,9));
		assertFalse(tree.isDecedent(23, -34));
